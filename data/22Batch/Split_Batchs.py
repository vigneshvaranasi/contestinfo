...
file_path = r"D:\Github Repositories\contestinfo\22.json"
...
with open('data/22Batch/01.json', 'w') as file:
    json.dump(part1, file, indent=4)

with open('data/22Batch/02.json', 'w') as file:
    json.dump(part2, file, indent=4)

with open('data/22Batch/03.json', 'w') as file:
    json.dump(part3, file, indent=4)

with open('data/22Batch/04.json', 'w') as file:
